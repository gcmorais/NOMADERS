...
function SignUp({ isOpen }) {
  ...
  const isFormValid =
    name && email && password && passconfirm && errors.length === 0;
      ...
      <Login navLink={onClose} width="lg:w-[500px]" height="h-[900px]">
        ...
        <main>
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            <FormGroup error={getErrorMessageByFieldName("senha")}>
              <Input
                ...
                error={
                  getErrorMessageByFieldName("senha")
                    ? "text-red-600"
                    : "text-black"
                }
              />
            ...
            <FormGroup error={getErrorMessageByFieldName("confirmar-senha")}>
              <Input
                ...
                error={
                  getErrorMessageByFieldName("confirmar-senha")
                    ? "text-red-600"
                    : "text-black"
                }
              />
          ...
          <p className="mb-10 mt-5 text-sm opacity-60">
            Já tem uma conta ?
            <Link to="/signin" className="font-semibold text-primary-indigo">
              {" "}
              Entrar
            </Link>
          </p>
