...
function Faq() {
  return (
    <section
      id="faq"
      className="bg-primary-white lg:h-[600px] py-28 font-inter"
    >
      <Framer>
        <div className="flex justify-center flex-col py-20 items-center gap-14 2xl:w-[50%] lg:w-[73%] lg:h-[600px] m-auto bg-primary-indigo lg:rounded-lg lg:mt-30">
          <img
            src={background}
            alt="bg-img"
            className="hidden absolute w-[45%] lg:block"
          />
          ...
          <Accordion className="gap-3 z-0 px-5 lg:px-24">
            <Accordion.Item
              value="first"
            ...
            >
              ...
              <Accordion.Panel className="m-auto lg:w-[95%]">
                <div className="border-t-[1px] pt-2">
                  ...
                  impostos, ou para seu controle pessoal.
                </div>
              </Accordion.Panel>
            </Accordion.Item>
            ...
            >
              <Accordion.Control className="rounded-md px-6 font-medium">
                Vendas nas plataformas são automaticamente inseridas no
                gerenciador ?
                <div className="bg-primary-white rounded-full p-1">
                  <Accordion.Icon />
                </div>
