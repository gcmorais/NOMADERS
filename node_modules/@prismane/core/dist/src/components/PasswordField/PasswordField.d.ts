...
/**
    ...
    */
declare const PasswordField: import("react").ForwardRefExoticComponent<Omit<PasswordFieldProps, "ref"> & import("react").RefAttributes<HTMLInputElement | HTMLTextAreaElement>>;
