...
/**
    ...
    */
declare const NumberField: import("react").ForwardRefExoticComponent<Omit<NumberFieldProps, "ref"> & import("react").RefAttributes<HTMLInputElement | HTMLTextAreaElement>>;
